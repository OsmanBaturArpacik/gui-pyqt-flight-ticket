...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.my_tickets_btn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.my_history_btn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.my_acc_about_btn = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Uçak Bileti Rezervasyon"))
        ...
        self.my_tickets_btn.setText(_translate("MainWindow", "Biletlerim"))
        self.my_history_btn.setText(_translate("MainWindow", "Geçmiş Seyahatlerim"))
        self.my_acc_about_btn.setText(_translate("MainWindow", "Hesap Bilgileri"))
        ...
        self.from_cmbx.setCurrentText(_translate("MainWindow", "İstanbul (Avrupa)"))
        self.from_cmbx.setItemText(0, _translate("MainWindow", "İstanbul (Avrupa)"))
        self.from_cmbx.setItemText(1, _translate("MainWindow", "İstanbul (Anadolu)"))
        self.from_cmbx.setItemText(2, _translate("MainWindow", "Ankara"))
        self.from_cmbx.setItemText(3, _translate("MainWindow", "İzmir"))
        self.from_cmbx.setItemText(4, _translate("MainWindow", "Kütahya"))
        self.label_6.setText(_translate("MainWindow", "Nereye?"))
        self.to_cmbx.setItemText(0, _translate("MainWindow", "İstanbul (Avrupa)"))
        self.to_cmbx.setItemText(1, _translate("MainWindow", "İstanbul (Anadolu)"))
        self.to_cmbx.setItemText(2, _translate("MainWindow", "Ankara"))
        self.to_cmbx.setItemText(3, _translate("MainWindow", "İzmir"))
        self.to_cmbx.setItemText(4, _translate("MainWindow", "Kütahya"))
        self.label_4.setText(_translate("MainWindow", "Gidiş Tarihi"))
        self.go_date.setDisplayFormat(_translate("MainWindow", "d/M/yyyy"))
        self.label_5.setText(_translate("MainWindow", "Dönüş Tarihi"))
        self.return_date.setDisplayFormat(_translate("MainWindow", "d/M/yyyy"))
        self.search_ticket_btn.setText(_translate("MainWindow", "Sorgula"))
        self.label_2.setText(_translate("MainWindow", "PNR Numarası Giriniz:"))
        self.pnr_ln.setPlaceholderText(_translate("MainWindow", "PNR GİRİNİZ: PC4175"))
        self.search_pnr_btn.setText(_translate("MainWindow", "Sorgula"))
