...
class Ui_dashboard_window(object):
    def setupUi(self, dashboard_window):
        ...
        dashboard_window.setEnabled(True)
        dashboard_window.resize(1000, 600)
        ...
        dashboard_window.setMinimumSize(QtCore.QSize(1000, 600))
        dashboard_window.setMaximumSize(QtCore.QSize(1000, 600))
